...
interface CardProps extends React.HTMLAttributes<HTMLDivElement> {
  variant?: "default" | "elevated" | "glass" | "status";
}
...
const Card = React.forwardRef<HTMLDivElement, CardProps>(
  ({ className, variant = "default", ...props }, ref) => {
    const variants = {
      ...
      glass: "bg-card/60 backdrop-blur-md text-card-foreground border border-border/50",
      status: "bg-card text-card-foreground border-l-4 shadow-soft",
    };
