...
const plans: Plan[] = [
  ...
  },
  {
    ...
    popular: true,
    savings: 'Save 10%',
    features: ['Everything in Monthly', 'Priority Support', 'Monthly Reports', 'SMS Alerts'],
  },
  {
    id: 'yearly',
    name: 'Yearly',
    ...
    duration: '12 months',
    savings: 'Save 20%',
    features: ['Everything in Quarterly', 'Dedicated Support', 'Advanced Analytics', 'Free Maintenance Check'],
  },
];
